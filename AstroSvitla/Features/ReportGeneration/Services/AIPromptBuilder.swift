...
struct AIPromptBuilder {
    ...
    func makePrompt(
...

        {
          ...
          \(knowledgeUsageSection),
          "share_content": {
            "condensed_summary": "Захоплюючий підсумок для Instagram (МАКСИМУМ 280 символів). Зачепи читача з першого речення, включи ключовий інсайт, заверши інтригою або надихаючою думкою.",
            "top_influences": [
              "☉ Сонце в [Знаку]: Короткий інсайт (макс 40 символів)",
              "☽ Місяць в [Знаку]: Короткий інсайт (макс 40 символів)",
              "♀ Венера в [Знаку]: Короткий інсайт (макс 40 символів)"
            ],
            "top_recommendations": [
              "Почни з дієслова - надихаюча порада №1 (макс 60 символів)",
              "Почни з дієслова - надихаюча порада №2 (макс 60 символів)",
              "Почни з дієслова - надихаюча порада №3 (макс 60 символів)"
            ],
            "analysis_highlights": [
              "Ключова риса особистості (макс 50 символів)",
              "Ще одна сильна сторона (макс 50 символів)",
              "Творчий/унікальний аспект (макс 50 символів)"
            ]
          }
        }
        \(sourcesInstructions)

        ВАЖЛИВО ПРО share_content (для Instagram):
        • condensed_summary: МАКСИМУМ 280 символів, захоплюючий та інтригуючий
        • top_influences: РІВНО 3 пункти, кожен МАКСИМУМ 40 символів, формат: "[Емодзі планети] Планета в Знаку: Інсайт"
        • top_recommendations: РІВНО 3 пункти, кожен МАКСИМУМ 60 символів, починай з дієслова
        • analysis_highlights: 3-4 пункти, кожен МАКСИМУМ 50 символів, позитивні риси
        • Використовуй планетарні емодзі: ☉ (Сонце), ☽ (Місяць), ☿ (Меркурій), ♀ (Венера), ♂ (Марс), ♃ (Юпітер), ♄ (Сатурн), ♅ (Уран), ♆ (Нептун), ♇ (Плутон)
    ...
    private func focus(for area: ReportArea) -> String {
        ...
        case .health:
            return """
            АНАЛІЗ БЛАГОПОЛУЧЧЯ - Фізичне, емоційне та енергетичне благополуччя:
